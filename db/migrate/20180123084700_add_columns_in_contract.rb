class AddColumnsInContract < ActiveRecord::Migration[5.1]
  def change
    ...
    # add_column :contracts, :company_name, :string
    # add_column :contracts, :company_address, :string
    # add_column :contracts, :company_website, :string
    # add_column :contracts, :fed_id, :string

    add_column :contracts, :show_accounting_to_employee, :boolean
    add_column :contracts, :candidate_id, :integer, index: true

    # add_column :contracts, :b_candidate_name, :string
    # add_column :contracts, :b_candidate_address, :string
    add_column :contracts, :b_ssn, :string

    add_column :contracts, :buy_company_id, :integer, index: true

    # add_column :contracts, :b_company_name, :string
    # add_column :contracts, :b_company_address, :string
    # add_column :contracts, :b_company_website, :string
    # add_column :contracts, :b_fed_id, :string
