...
class CouponsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create coupon" do
    assert_difference('Coupon.count') do
      post coupons_url, params: { coupon: { name: @coupon.name, used_times: @coupon.used_times, validated_till: @coupon.validated_till } }
    end
  ...
  test "should update coupon" do
    patch coupon_url(@coupon), params: { coupon: { name: @coupon.name, used_times: @coupon.used_times, validated_till: @coupon.validated_till } }
