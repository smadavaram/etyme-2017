...
#     end
  ...
  def mini_chat_contact_widget(email, phone, _user_id = nil, _options = {})
    mail_to(email, content_tag(:i, nil, class: 'os-icon os-icon-email-2-at2 mini_chat_widget pt-3',style:' font-size: 20px !important;  padding: 4px important!; color: grey !important;').html_safe, title: email, class: 'data-table-icons') +
      ...
      "<div title = 'Add to Calendar' class = 'addeventatc z-100'>
        ...
        <span class='title'></span>
        <span class = 'description' ></span>
        <span class='os-icon os-icon-calendar mini_chat_widget' style:'font-size: 25px; !important; padding: 5px; color: grey !important;'></span>
        <span class='attendees'></span>
      </div >".html_safe
  end
