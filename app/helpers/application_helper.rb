...
def render_stars(value)
  ...
  floored.times { output += "<i class='fa fa-star' aria-hidden='true'></i>" }
  ...
  #stars
  (5 - value).to_i.times { output += "<i class='fa fa-star empty-star' aria-hidden='true'></i>" }
  output.html_safe
end