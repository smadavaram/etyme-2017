...
var addeventatc = function () {
  var u, v, s, t, e = !1, l = 1, r = !1, p = !0, m = !1, g = !1, h = !1, E = 1, f = "", w = !0, x = !0, b = !0, k = !0,
    ...
    I = "Yahoo <em>(online)</em>", A = "Facebook Event", S = null, $ = null, a = null, L = null, H = null, R = null,
    M = !1;
  return {
    initialize: function () {
      if (!e) {
      ...
      for (var c = document.getElementsByTagName("*"), i = 0; i < c.length; i += 1) addeventatc.hasclass(c[i], "addeventatc") && function () {
        var a = "addeventatc" + l;
        c[i].id = a, addeventatc.hasclass(c[i], "keeptitle") || (c[i].title = ""), c[i].style.visibility = "visible", c[i].setAttribute("aria-haspopup", "true"), c[i].setAttribute("aria-expanded", "false"), c[i].setAttribute("tabindex", "0"), c[i].setAttribute("translate", "no"), c[i].onmouseout = r ? (c[i].onclick = function () {
          return !1
        }, c[i].onmouseover = function () {
          clearTimeout(s), addeventatc.toogle(this, {type: "mouseover", id: a})
        }, function () {
      ...
      if (n = $d(a = e.id)) {
        ...
        var i = n.getAttribute("data-intel"), s = n.getAttribute("data-intel-apple");
        if ("ios" == addeventatc.agent() && "click" == t.type && "true" !== s && "false" !== i && (o = "appleical", n.setAttribute("data-intel-apple", "true")), "outlook" == o || "google" == o || "yahoo" == o || "hotmail" == o || "outlookcom" == o || "appleical" == o || "apple" == o || "facebook" == o) "click" == t.type && (addeventatc.click({
          button: a,
          service: o,
          id: t.id
        }), null != S && addeventatc.trigger("button_click", {id: a})); else if ("mouseover" == t.type && v != n && (h = !1), "click" == t.type || "render" == t.type || "mouseover" == t.type && !h) {
          "mouseover" == t.type && (h = !0, null != $ && addeventatc.trigger("button_mouseover", {id: a})), d = addeventatc.getburl({
            id: a,
            facebook: !0
          }), "" == f && (f = "appleical,google,outlook,outlookcom,yahoo,facebook");
          for (var l = (f = (f += ",").replace(/ /gi, "")).split(","), r = 0; r < l.length; r += 1) (w && "ical" == l[r] || w && "appleical" == l[r]) && (c += '<span class="ateappleical" id="' + a + '-appleical" role="menuitem">' + T + "</span>"), x && "google" == l[r] && (c += '<span class="ategoogle" id="' + a + '-google" role="menuitem">' + N + "</span>"), b && "outlook" == l[r] && (c += '<span class="ateoutlook" id="' + a + '-outlook" role="menuitem">' + z + "</span>"), (k && "hotmail" == l[r] || k && "outlookcom" == l[r]) && (c += '<span class="ateoutlookcom" id="' + a + '-outlookcom" role="menuitem">' + C + "</span>"), y && "yahoo" == l[r] && (c += '<span class="ateyahoo" id="' + a + '-yahoo" role="menuitem">' + I + "</span>"), d && "facebook" == l[r] && _ && "facebook" == l[r] && (c += '<span class="atefacebook" id="' + a + '-facebook" role="menuitem">' + A + "</span>");
      ...
      if (void 0 === location.origin && (o = location.protocol + "//" + location.host), t = $d(e.button)) {
        ...
        var s = $d("atecllink");
        if (s.target = d ? "_blank" : "_self", s.href = n, addeventatc.eclick("atecllink"), addeventatc.track({
          typ: "click",
          cal: e.service
        }), null != R) {
      ...
      if (a && n) if ("block" == addeventatc.getstyle(n, "display")) addeventatc.hideandreset(); else {
        ...
        var o = a.getAttribute("data-dropdown-x"), d = a.getAttribute("data-dropdown-y"), c = "auto", i = "auto";
        null != o && (i = o), null != d && (c = d), n.style.left = "0px", n.style.top = "0px", n.style.display = "block";
        var s = parseInt(a.offsetHeight), l = parseInt(a.offsetWidth), r = parseInt(n.offsetHeight),
          ...
          x = (parseInt(f.y), addeventatc.elementposition(a)), b = (x.x, w + p), k = v + g, y = 0, _ = 0, T = "",
          N = x.y - (r / 2 - s);
        "down" == c && "left" == i ? (_ = y = "-2px", T = "topdown") : "up" == c && "left" == i ? (y = "0px", _ = -(r - s - 2) + "px") : "down" == c && "right" == i ? (y = -(p - l - 2) + "px", _ = "-2px", T = "topdown") : "up" == c && "right" == i ? (y = -(p - l - 2) + "px", _ = -(r - s - 2) + "px") : "auto" == c && "left" == i ? (y = "0px", N < h ? (_ = "-2px", T = "topdown") : _ = h + m < N + r ? -(r - s - 2) + "px" : -(r / 2 - s) + "px") : "auto" == c && "right" == i ? (y = -(p - l - 2) + "px", N < h ? (_ = "-2px", T = "topdown") : _ = h + m < N + r ? -(r - s - 2) + "px" : -(r / 2 - s) + "px") : "down" == c && "auto" == i ? (y = k < b ? -(p - l - 2) + "px" : "-2px", _ = "-2px", T = "topdown") : "up" == c && "auto" == i ? (y = k < b ? -(p - l - 2) + "px" : "-2px", _ = -(r - s - 2) + "px") : (N < h ? (_ = "-2px", T = "topdown") : _ = h + m < N + r ? -(r - s - 2) + "px" : -(r / 2 - s) + "px", y = k < b ? -(p - l - 2) + "px" : "-2px"), n.style.left = y, n.style.top = _, "" != T && (n.className = n.className + " " + T), setTimeout(function () {
          n.className = n.className + " addeventatc-selected"
        }, 1), "click" == t.type && null != S && addeventatc.trigger("button_click", {id: e}), null != L && addeventatc.trigger("button_dropdown_show", {id: e})
      }
    }, hide: function (e) {
      var t = !1;
      ...
      "button-click" == e && (S = t), "button-mouseover" == e && ($ = t), "button-mouseout" == e && (a = t), "button-dropdown-show" == e && (L = t), "button-dropdown-hide" == e && (H = t), "button-dropdown-click" == e && (R = t)
    }, settings: function (e) {
      ...
      return (n && o || n && t) && (alert("Should the event fail to get added to your calendar, please open this webpage in Safari."), e = !0), e
    }, agent: function () {
