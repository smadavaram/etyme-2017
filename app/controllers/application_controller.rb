class ApplicationController < ActionController::Base
  ...
  def get_new_notification_flash(resource)
    ...
    flash[:success] = (notifications_count.zero? and messages_count.zero?) ? "Welcome back, You do not have any new notification or message" : "Welcome back, You have #{notifications_count} new notification(s) and #{messages_count} message(s)"
  end
