class Static::JobApplicationsController < ApplicationController
  ...
  def job_application_params
    params.require(:job_application).permit([ :message , :cover_letter ,:candidate_email,:candidate_first_name,:candidate_last_name, :status,:resume, custom_fields_attributes:
        [
            :id,
            :name,
            :value
