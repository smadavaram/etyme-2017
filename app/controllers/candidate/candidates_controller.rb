...
class Candidate::CandidatesController < Candidate::BaseController
  ...
  def candidate_params
    params.require(:candidate).permit(:first_name, :last_name, :display_name ,:invited_by, :ssn, :passport_number, :relocation, :visa_type, :job_id, :description, :last_nam, :dob, :about_summary, :email, :phone_country_code, :phone, :visa, :skill_list, :designate_list, :primary_address_id, :category, :subcategory, :dept_name, :industry_name, :selected_from_resume, :ever_worked_with_company, :designation_status, :facebook_url, :twitter_url, :linkedin_url, :gtalk_url, :skypeid, :work_type, :address,
