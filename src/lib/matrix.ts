      ...
      { code: 'L2.3.1', name: 'Capture', domain: 'DEMAND', processes: [
        ...
        { code: 'L3.3.1.3', name: 'Milestone capture', owner: 'Delivery manager', status: P,
          tasks: ['Deliverable submitted for acceptance',
            ...
            'The delivery-to-acceptance gap in days — outstanding until deliveredAt exists on the model'],
          implementedBy: [
  ...
  },
  {
    ...
    groups: [
      { code: 'L2.4.1', name: 'Billing', domain: 'MONEY', processes: [
        ...
        { code: 'L3.4.1.3', name: 'Tax determination', owner: 'Controller', status: P,
          tasks: ['Place of supply and rate, as a rule table', 'Withholding where it applies', 'Refuses rather than guesses where the place of supply is unknowable'],
          implementedBy: ['src/lib/billing-cascade.ts', 'src/app/api/invoices/generate/route.ts'],
      ...
      { code: 'L2.4.3', name: 'Credit management', domain: 'MONEY', processes: [
        ...
        { code: 'L3.4.3.2', name: 'Limit and breach', owner: 'Controller', status: B,
          ...
          testedBy: ['__tests__/invariants/credit.test.ts'] },
        { code: 'L3.4.3.3', name: 'Collections and escalation', owner: 'Controller', status: P,
          tasks: ['Owned, promised, broken, stop-work advised — the ladder beyond the letters', 'Factoring eligibility and reason-coded write-offs', 'A promise-to-pay that persists — outstanding until the columns exist'],
    ...
    groups: [
      { code: 'L2.5.1', name: 'Worker pay', domain: 'MONEY', processes: [
        ...
        { code: 'L3.5.1.4', name: 'Off-cycle and corrections', owner: 'Payroll', status: P,
          tasks: ['Short pay carried, never a negative payslip', 'The carry derived from postings, never a stored running total', 'A screen a person can reach it from — the one thing outstanding'],
