    ...
    groups: [
      ...
      { code: 'L2.4.2', name: 'Accounts receivable', domain: 'MONEY', processes: [
        { code: 'L3.4.2.1', name: 'AR ageing and dunning', owner: 'AR clerk', status: B,
          ...
          implementedBy: ['src/lib/ar-ageing.ts', 'src/app/api/ar/route.ts', 'src/app/dashboard/ar/page.tsx'],
      ...
      { code: 'L2.4.3', name: 'Credit management', domain: 'MONEY', processes: [
        ...
        { code: 'L3.4.3.2', name: 'Limit and breach', owner: 'Controller', status: P,
  ...
  },
  {
    ...
    groups: [
      ...
      { code: 'L2.5.2', name: 'Accounts payable', domain: 'MONEY', processes: [
        { code: 'L3.5.2.1', name: 'Vendor bill intake', owner: 'AP clerk', status: N,
        ...
        { code: 'L3.5.2.4', name: 'Chain payment behaviour', owner: 'Controller', status: N,
          tasks: [
